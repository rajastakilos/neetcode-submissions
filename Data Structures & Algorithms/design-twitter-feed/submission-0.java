...
class Twitter {
    ...
    private Map<Integer, Tweet> tweetHeads = new HashMap<>();

    public Twitter() {}

    public void postTweet(int userId, int tweetId) {
        Tweet newTweet = new Tweet(tweetId, time++);
        newTweet.next = tweetHeads.get(userId);
