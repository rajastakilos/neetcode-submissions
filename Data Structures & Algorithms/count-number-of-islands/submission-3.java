...
// Time: O(m * n). Must check each cell at most once. 
// Space: O(m * n) Worst case for recursion stack when grid is entirely land. 
    // Can use BFS with a queue or DFS with an explicit stack to avoid overflow. 
